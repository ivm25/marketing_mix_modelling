...
app.layout = html.Div(children=[navbar,
    ...
    )),dbc.Col(dcc.Graph(id="graph", style = {'width': '600px'}),lg=6, md=12, sm = 24)]),
    ...
    dbc.Col(dcc.Graph(id = "graph_2", style ={'width': '600px'}),lg=6, md=12, sm = 24)]),
    ...
    dbc.Row([dbc.Col(dcc.Graph(id = "heatmap", style = {'display': 'inline-block'}),lg=6, md=12, sm = 24),
             dbc.Col(dcc.Graph(id = "time_series", style = {'display': 'inline-block'}),lg=6, md=12, sm = 24)])
])
