...
app.layout = html.Div(children=[navbar,
    ...
    dbc.Row([dbc.Col(dcc.Graph(id="graph", style = {'display': 'inline-block'}),lg=3, md=6, sm = 12),
    dbc.Col(dcc.Graph(id = "graph_2", style ={'display': 'inline-block'}),lg=3, md=6, sm = 12)]),
    ...
    dbc.Row([dbc.Col(dcc.Graph(id = "heatmap", style = {'display': 'inline-block'}),lg=3, md=6, sm = 12),
             dbc.Col(dcc.Graph(id = "time_series", style = {'display': 'inline-block'}),lg=3, md=6, sm = 12)])
])
